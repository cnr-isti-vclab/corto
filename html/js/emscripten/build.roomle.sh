...
-s ALLOW_MEMORY_GROWTH=1 -s TOTAL_STACK=24576 -s TOTAL_MEMORY=1048576 -o decoder_base.roomle.wasm

#-g \
#--debug \
#-fsanitize=undefined \
#--source-map-base "http://localhost/devel/nexus/html/js/decoder_base.roomle.wasm.map" \
#-s SAFE_HEAP=1 \
#-O3 -DNDEBUG \
...
hexdump -v -e '1/1 "%02X"' decoder_base.roomle.wasm >> sed_command.txt
echo "\";#" >> sed_command.txt
sed -f sed_command.txt corto.em.proto.roomle.js > ../corto.em.roomle.js
